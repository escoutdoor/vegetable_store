...
const file_auth_v1_service_proto_rawDesc = "" +
	"\n" +
	"\x15auth/v1/service.proto\x12\aauth.v1\x1a\x16auth/v1/messages.proto\x1a\x1cgoogle/api/annotations.proto\x1a.protoc-gen-openapiv2/options/annotations.proto2\x97\x03\n" +
	"\vAuthService\x12Q\n" +
	...
	"\rValidateToken\x12\x1d.auth.v1.ValidateTokenRequest\x1a\x1e.auth.v1.ValidateTokenResponse\"\x1c\x82\xd3\xe4\x93\x02\x16:\x01*\"\x11/v1/auth/validateB\xe9\x01\x92AK\x12E\n" +
	"\x1cVegetable Store Auth Service\" \n" +
	"\n" +
	"Ivan Popov\x1a\x12vanap387@gmail.com2\x031.0*\x02\x01\x02\n" +
	"\vcom.auth.v1B\fServiceProtoP\x01ZAgitbub.com/escoutdoor/vegetable_store/common/pkg/api/auth/v1;auth\xa2\x02\x03AXX\xaa\x02\aAuth.V1\xca\x02\aAuth\\V1\xe2\x02\x13Auth\\V1\\GPBMetadata\xea\x02\bAuth::V1b\x06proto3"
...
var file_auth_v1_service_proto_depIdxs = []int32{
	...
	6, // 6: auth.v1.AuthService.RefreshToken:output_type -> auth.v1.RefreshTokenResponse
